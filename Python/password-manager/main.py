...
logo_img = tk.PhotoImage(file="Python/password-manager/logo.png")
...
btn_generate = ttk.Button(root, text="Generate Password", command="")
btn_generate.grid(column=2, row=3)

btn_add = ttk.Button(root, text="Add", command="", width=40)
